#!/bin/bash -ue
medaka_consensus -i barcode2.fq.gz -d targets.fasta -o barcode2_consensus
...
bcftools consensus -f targets.fasta barcode2_consensus/medaka.annotated.vcf.gz         -i 'FILTER="PASS"'         -o barcode2_consensus/barcode2.fas
